...
def parse_arguments(argv):
    ...
    args1["pipeline.model.proposal_net_args_list.0.log2_hashmap_size"] = str(int(Z - 7))
    ...
    args1["pipeline.model.proposal_net_args_list.1.log2_hashmap_size"] = str(int(Z - 7))
