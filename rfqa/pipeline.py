...
from nerfstudio.pipeline.base_pipeline import Pipeline
...
class VanillaPipeline(Pipeline):
    ...
    def get_training_callbacks(
        ...
        def write_model_stats(step):
            ...
            non_trainable_params = sum(p.numel() for p in parameters if not p.requires_grad)

            writer.put_dict(name="Model Statistics", scalar_dict={
                "data_size": data_size,
